  ...
  return (
    <div className='bg-white sticky top-0 z-50'>
      ...
      <header className="relative bg-white">
        <p className="flex h-10 items-center justify-center bg-gradient-to-r from-purple-600 to-blue-600 px-4 text-sm font-medium text-white sm:px-6 lg:px-8" 
        style={{ backgroundColor: mode === 'dark' ? 'rgb(62 64 66)' : '', color: mode === 'dark' ? 'white' : '', }}>
          🚚 Free delivery on orders over ₹300 | 🎉 Use code SAVE20 for 20% off
        </p>
              ...
              <div className="ml-4 flex lg:ml-0">
                <Link to={'/'} className='flex items-center'>
                  <div className="flex items-center">
                    <div className="w-8 h-8 bg-gradient-to-r from-purple-600 to-blue-600 rounded-full mr-2 flex items-center justify-center">
                      <span className="text-white font-bold text-sm">CW</span>
                    </div>
                    <h1 className='text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent'>Crafted-Wonders</h1>
                  </div>
                </Link>
              </div>
